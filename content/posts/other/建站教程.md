...
disableInlineCSS: true
```
- 上面代码用obsidian插件折叠：[mugiwara85/CodeblockCustomizer: Codeblock Customizer plugin for Obsidian (github.com)](https://github.com/mugiwara85/CodeblockCustomizer)
